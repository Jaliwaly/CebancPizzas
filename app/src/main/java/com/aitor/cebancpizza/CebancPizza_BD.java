...
public class CebancPizza_BD extends SQLiteOpenHelper {
    ...
    String articulos ="CREATE TABLE IF NOT EXISTS ARTICULOS (IDARTICULO NUMBER NOT NULL, NOMBRE TEXT, TIPO TEXT, PRVENT NUMBER(4,2), IMAGEN TEXT, PRIMARY KEY(IDARTICULO))";
